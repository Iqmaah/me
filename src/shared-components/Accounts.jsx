...
const Accounts = () => {
    ...
    return(
            ...
            <div className="rounded-2xl border border-gray-300 p-8 w-1/2 h-auto">
                                <div className="flex flex-cols items-center space-x-4 my-8">
                                    
                                    <span className="pr-44">
                                        <h className="text-[16px] font-[400px] leading-6">0179212223</h>
                                        <p className="text-[14px] font-[500px] leading-6 MediumFonter">Account number</p>
                                    </span> 
                                ...
                                <div className="flex flex-cols items-center space-x-4 my-8">
                                    ...
                                    <span className="pr-48">
                                        <h className="text-[16px] font-[400px] leading-6">223341234</h>
                                ...
                                <div className="flex flex-cols items-center space-x-4 my-8">
                                    ...
                                    <span className="pr-36">
                                        <button className="text-[14px] font-[500px] leading-6 MediumFonter" onClick={() => setShowModal(true)}>Add a new bank account</button>
                                    </span> 
                                </div><hr/>
                                ...
                                <div className="flex flex-cols items-center space-x-4 my-8">
                                    ...
                                    <span className="pr-36">
                                        <p className="text-[14px] font-[500px] leading-6 MediumFonter">Send to purse</p>
                                    </span> 
                                    <span className="flex justify-end">
                                        <img src={arrow}></img>
                                    </span>
