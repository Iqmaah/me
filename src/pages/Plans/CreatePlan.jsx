        ...
        <div className="flex min-h-screen bg-slate-50 pb-20">
            ...
            <div>
                ...
                <div className='bg-white grid sm:grid-rows-1 md:grid-cols-2 gap-32 h-screen rounded-2xl m-8 px-12 py-12'>
                    <div>
                        <h className="text-[32px] font-[700px] leading-10 BoldFonter">Create a Plan</h>
                        ...
                        <form onSubmit={handleOnSubmit}>
                                ...
                                <div>
                                    <label for="default-toggle" className="relative inline-flex items-center mb-4 cursor-pointer">
                                        ...
                                        <span className="ml-6 text-[12px] font-[300px] leading-4 dark:text-gray-300">Automate savings</span>
                                        <span className="ml-6">
