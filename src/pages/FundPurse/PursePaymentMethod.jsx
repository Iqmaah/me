        ...
        <div className="flex min-h-screen bg-slate-50 pb-20">
            ...
            <div>
                    ...
                    <div className="mx-8 mb-8">
                        ...
                        <span className="text-[#5B2E4F] text-[14px] font-[400px] leading-5 ml-2"><Link to="/CreatePlan">Fund Purse</Link></span>
                    </div>
...
export default PursePaymentMethod