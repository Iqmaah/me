                        ...
                        <div className="px-12 pb-10 pt-12">
                            ...
                            <div className="grid grid-rows-3 gap-4">
                                 <div className=''>
                                    ...
                                    <p className='px-8 text-[16px] font-[400px] leading-6'>We offer easy-to-use platform designs, frictionless user experience and a guided approach to investing for women.</p> 
                                </div>
                                <div className=''>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-[#5B2E4F]"  viewBox="0 0 20 20" fill="currentColor">
                                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                                    ...
                                    <p className='px-8 text-[16px] font-[400px] leading-6'>All funds are held and managed by FBNQuest Trustees Limited, a member of the FBN Holdings on behalf of HerVest. FBNQuest Trustees Limited is regulated by the Securities and Exchange Commission (SEC).</p> 
                                </div>
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-[#5B2E4F]"  viewBox="0 0 20 20" fill="currentColor">
                                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
