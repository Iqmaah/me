        ...
        <div className="flex min-h-screen bg-slate-50 pb-20">
            ...
            <div>
                <div className="mx-8 mt-8 mb-6 font-bold">
                    <h1 className="text-[32px] font-[700px] leading-8 ">Banks & Cards</h1>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl m-4 border">
                    ...
                    <div className="flex flex-row  space-x-8 items-center pb-6 ">
                            ...
                            <div className=''>
                                <Link to="/Banks">
                                    <p className='text-[14px] font-[400px] leading-5 float-right'>Banks</p>
                                </Link>
                            </div>  
                    </div><hr/>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-6">
                        ...
                        <div className= "w-72 h-44 max-w-sm rounded-3xl px-6 flex items-center space-x-4 border border-gray-200 shadow-md bg-[#265859] text-white " style={{ backgroundImage: `url(${bankbg})`, backgroundSize: "", backgroundRepeat: "no-repeat", backgroundPosition: "",}}>
                            {/* <Link to="/CreatePlan">    */}
                                <div className="">
                                    <h2 className="BoldFonter text-[24px] font-[700px] leading-8 mb-2"> Ozenua Tobi</h2>
                                    <p className=" text-[16px] font-[400px] leading-6">0123456789 - GTBank</p>     
                                </div>
                            {/* </Link>     */}
                        </div>
                        <div className= "w-72 h-44 max-w-sm rounded-3xl px-6 flex items-center border border-gray-200 shadow-md bg-[#33343D] text-white " style={{ backgroundImage: `url(${bankbg})`, backgroundSize: "", backgroundRepeat: "no-repeat", backgroundPosition: "",}}>
                            {/* <Link to="/CreatePlan">    */}
                                <div className="">
                                    <h2 className="BoldFonter text-[24px] font-[700px] leading-8 mb-2"> Ozenua John </h2>
                                    <p className=" text-[16px] font-[400px] leading-6">0987654321 - Polaris Bank</p>     
                                </div>
                            {/* </Link>     */}
                        </div> 
                        ...
                        <button className= "grid grid-rows-2 gap-4 pt-5 pr-5 pl-5  bg-white rounded-3xl border border-gray-200 shadow-md " onClick={() => setShowModal(true)}>
                                    ...
                                    <div className='mb-4'>
                                        <h2 className="text-[#B4B5C1] BoldFonter text-[24px] font-[700px] leading-8">Add a new bank</h2>
                                    </div>
                        </button> 
                                            ...
                                            <div className="flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                                                <div className="relative w-auto my-6 mx-auto max-w-3xl">
                                                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                                        <div className="p-12">
                                                            <h1 className="text-center BoldFonter mb-2 px-4 text-[24px] font-[700px] leading-8" >Add bank</h1>
                                                            ...
                                                            <form onSubmit={onSubmit}>
                                                                ...
                                                                <div className='w-full'>
                                                                    <label htmlFor="Accountholder name" className="sr-only">Accountholder name</label>
                                                                    <PrimaryFormField type="text" placeholder="Accountholder name" onChange={(e) => setAccountholderName(e.target.value)} value={AccountholderName} />
                                                                </div><br />
